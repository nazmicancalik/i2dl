...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        o1, cache1 = affine_relu_forward(
            X, self.params['W1'], self.params['b1'])
        scores, cache2 = affine_forward(
            o1, self.params['W2'], self.params['b2'])
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        ############################################################################
        data_loss, dw2 = softmax_loss(scores, y)
        dw1, dw2, db2 = affine_backward(dw2, cache2)
        _, dw1, db1 = affine_relu_backward(dw1, cache1)

        # Add regularization loss to necessary parts.
